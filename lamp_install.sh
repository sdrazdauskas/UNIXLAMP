...
apt-get update
apt-get install -y build-essential pkg-config libssl-dev cmake libncurses5-dev bison libcurl4-openssl-dev libpng-dev libxpm-dev libfreetype6-dev libmcrypt-dev libreadline-dev git wget tar sqlite3
